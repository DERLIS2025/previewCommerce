...
export const categories = ["Empastado", "Riego", "Jardinería", "Paisajismo", "Plagas", "Decoración exterior"];
...
export const productDummyData = [
    {
        id: "prod_1",
        name: "Césped en rollo natural",
        description: "Césped en rollo ideal para transformar patios, jardines y espacios exteriores con una terminación uniforme, fresca y natural. Excelente opción para lograr un jardín prolijo y de rápida instalación.",
        mrp: 95000,
        price: 78000,
    ...
    {
        id: "prod_2",
        name: "Riego automático para jardín",
        description: "Sistema de riego pensado para mantener el jardín en óptimas condiciones con una distribución de agua más práctica y eficiente. Ideal para hogares, patios amplios y áreas verdes.",
        mrp: 320000,
        price: 275000,
        images: [product_img2],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Servicio orientado al cuidado continuo de jardines residenciales y comerciales. Incluye tareas para conservar el césped, mejorar la presentación del espacio y mantener un entorno verde ordenado.",
        mrp: 250000,
        price: 210000,
        images: [product_img3],
        storeId: "seller_1",
    ...
    {
        id: "prod_4",
        name: "Control de plagas exterior",
        description: "Solución para el control y prevención de plagas en jardines y áreas exteriores. Pensado para ayudar a mantener espacios más limpios, seguros y agradables.",
        mrp: 180000,
        price: 145000,
        images: [product_img4],
        storeId: "seller_1",
    ...
    {
        id: "prod_5",
        name: "Paisajismo para exteriores",
        description: "Propuesta de diseño y mejora de áreas verdes para dar un estilo más armónico, natural y atractivo al entorno. Ideal para viviendas, jardines amplios y espacios corporativos.",
        mrp: 450000,
        price: 390000,
        images: [product_img5],
        storeId: "seller_1",
    ...
    {
        id: "prod_6",
        name: "Piedra decorativa para jardín",
        description: "Piedra decorativa ideal para realzar senderos, canteros y sectores verdes. Aporta un acabado más elegante y ayuda a mejorar la presentación del jardín.",
        mrp: 130000,
        price: 99000,
        images: [product_img6],
        storeId: "seller_1",
    ...
    {
        id: "prod_7",
        name: "Bordes para jardín",
        description: "Elemento funcional y decorativo para delimitar espacios verdes, senderos y canteros. Ayuda a mantener el orden visual y mejora el acabado general del jardín.",
        mrp: 85000,
        price: 69000,
        images: [product_img7],
        storeId: "seller_1",
    ...
    {
        id: "prod_8",
        name: "Grama sintética decorativa",
        description: "Alternativa práctica para espacios que buscan una apariencia verde constante con bajo mantenimiento. Ideal para patios, terrazas y sectores decorativos.",
        mrp: 210000,
        price: 175000,
        images: [product_img8],
        storeId: "seller_1",
    ...
    {
        id: "prod_9",
        name: "Aspersor para riego",
        description: "Accesorio de riego útil para distribuir agua de forma uniforme en césped y jardines. Ideal para complementar sistemas automáticos o usos manuales.",
        mrp: 65000,
        price: 52000,
        images: [product_img9],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Tierra preparada para mejorar la base del jardín y favorecer un entorno más sano para césped, plantas y áreas verdes. Ideal para trabajos de jardinería y renovación.",
        mrp: 90000,
        price: 74000,
    ...
    {
        id: "prod_11",
        name: "Maceta decorativa exterior",
        description: "Maceta pensada para complementar jardines, galerías y patios con un estilo más prolijo y natural. Ideal para sumar presencia visual a plantas ornamentales.",
        mrp: 120000,
        price: 98000,
    ...
    {
        id: "prod_12",
        name: "Servicio de limpieza de jardín",
        description: "Servicio enfocado en ordenar, limpiar y recuperar espacios verdes para que luzcan mejor y transmitan una imagen más cuidada. Ideal para hogares y áreas exteriores amplias.",
        mrp: 280000,
        price: 235000,
